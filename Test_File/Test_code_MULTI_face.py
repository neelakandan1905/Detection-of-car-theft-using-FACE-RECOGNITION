...
# Path defined
path= 'D:/PROJECT/Car_theft/Face_Reco_HOG/Test_File/Test_image_MULTI_faces/'
images = []
test_names = []
test = os.listdir('D:/PROJECT/Car_theft/Face_Reco_HOG/Test_File/Test_image_MULTI_faces/')
#print(test)
